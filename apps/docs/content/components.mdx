...
Shared components live in `packages/ui`. The docs project is the written reference for those components, while Storybook is the interactive workbench and component catalog.

Components are data-agnostic. They do not fetch profile data, own editorial content, or assume docs-specific prose styling.
...
- This page documents the component contract for readers.
